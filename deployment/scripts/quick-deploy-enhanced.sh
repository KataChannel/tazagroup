...
# 🔧 Katadev Quick Deploy - Enhanced Version
...
echo -e "${CYAN}${ICON_ROCKET} Katadev Quick Deploy - Enhanced Version${NC}"
echo "============================================="
...
if [[ ! -f "deploy-remote-fixed.sh" ]]; then
    error "Please run this script from the Katadev root directory"
