...
# 🔑 Katadev SSH Key Generation & Setup Script
...
create_ssh_config() {
    ...
    local config_entry="
# Katadev Deployment Server - Generated $(date)
...
show_usage_instructions() {
    ...
    echo -e "${YELLOW}Use with Katadev deployment:${NC}"
...
main() {
    ...
    info "Use the generated key for secure remote deployment with Katadev"
}
