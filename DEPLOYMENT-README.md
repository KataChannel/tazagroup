...
Complete guide for deploying Katadev using the automated deployment scripts.
...
DATABASE_URL=postgresql://katadev:<password>@postgres:5432/katadev
...
docker compose exec postgres psql -U katadev -d katadev
```
...
**Built with ❤️ by the Katadev Team**
