export const siteConfig = {
    ...
    logo: {
        ...
        alt: "Tazav1 - Monochrome UI System",
    },
    
    // SEO configuration
    seo: {
        titleTemplate: "%s | Tazav1",
        titleSeparator: "|",
        titleSuffix: "Tazav1",
        description: "Tazav1 - Hệ thống giao diện đơn sắc với hỗ trợ đa ngôn ngữ và chế độ tối.",
        keywords: [
            "monochrome ui",
            "dark mode",
            "multi-language",
