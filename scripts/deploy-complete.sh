...
cat << "EOF"
  _____                                          
 |_   _|_ _ ______ _  __ _ _ _ ___ _  _ _ __    
   | |/ _` |_ / _` |/ _` | '_/ _ \ || | '_ \   
   |_|\__,_/__\__,_|\__, |_| \___/\_,_| .__/   
                    |___/             |_|      
   
  Optimized Deployment Pipeline
  Build Local → Export → Deploy on Server
EOF
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo "  Frontend:  http://${SERVER_HOST}:13000"
echo "  Backend:   http://${SERVER_HOST}:13001"
echo "  GraphQL:   http://${SERVER_HOST}:13001/graphql"
echo ""

echo -e "${CYAN}📝 Useful Commands:${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo "  View logs:     ssh ${SERVER_USER}@${SERVER_HOST} 'cd ${SERVER_PATH} && docker-compose -f docker-compose.deploy.yml logs -f'"
echo "  Check status:  ssh ${SERVER_USER}@${SERVER_HOST} 'cd ${SERVER_PATH} && docker-compose -f docker-compose.deploy.yml ps'"
echo "  Stop all:      ssh ${SERVER_USER}@${SERVER_HOST} 'cd ${SERVER_PATH} && docker-compose -f docker-compose.deploy.yml down'"
echo "  Restart:       ssh ${SERVER_USER}@${SERVER_HOST} 'cd ${SERVER_PATH} && docker-compose -f docker-compose.deploy.yml restart'"
echo ""
