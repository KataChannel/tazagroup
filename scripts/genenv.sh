...
DB_PASSWORD=$(openssl rand -base64 8 | tr -d "=+/" | cut -c1-32)
REDIS_PASSWORD=$(openssl rand -base64 8 | tr -d "=+/" | cut -c1-32)
JWT_SECRET=$(openssl rand -base64 32 | tr -d "\n")
ENCRYPTION_KEY=$(openssl rand -base64 8 | tr -d "=+/" | cut -c1-32)
MINIO_ROOT_PASSWORD=$(openssl rand -base64 8 | tr -d "=+/" | cut -c1-32)
MINIO_ACCESS_KEY=$(openssl rand -base64 8 | tr -d "=+/" | cut -c1-32)
PGADMIN_PASSWORD=$(openssl rand -base64 8 | tr -d "=+/" | cut -c1-32)
GRAFANA_PASSWORD=$(openssl rand -base64 8 | tr -d "=+/" | cut -c1-32)
