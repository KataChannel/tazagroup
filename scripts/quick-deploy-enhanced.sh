...
# 🔧 Tazav1 Quick Deploy - Enhanced Version
...
echo -e "${CYAN}${ICON_ROCKET} Tazav1 Quick Deploy - Enhanced Version${NC}"
echo "============================================="
...
if [[ ! -f "deploy-remote-fixed.sh" ]]; then
    error "Please run this script from the Tazav1 root directory"
