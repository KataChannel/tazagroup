...
import { ListKhoComponent } from '../listkho/listkho.component';
...
import { GenId, convertToSlug } from '../../../shared/utils/shared.utils';
  @Component({
    ...
    templateUrl: './detailkho.component.html',
    styleUrl: './detailkho.component.scss'
  })
      ...
      effect(async () => {
        ...
        if(id === '0'){
          ...
          this._router.navigate(['/admin/kho', "0"]);
            ...
            await this._KhoService.getKhoByid(id);
            this._ListkhoComponent.drawer.open();
