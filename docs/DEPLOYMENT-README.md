...
Complete guide for deploying Tazav1 using the automated deployment scripts.
...
DATABASE_URL=postgresql://tazav1:<password>@postgres:5432/tazav1
...
docker compose exec postgres psql -U tazav1 -d tazav1
```
...
**Built with ❤️ by the Tazav1 Team**
