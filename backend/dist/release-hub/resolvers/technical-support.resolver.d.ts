...
export declare class TechnicalSupportResolver {
    private readonly supportService;
    constructor(supportService: TechnicalSupportService);
    ...
    createTechnicalSupportMessage(input: CreateTechnicalSupportMessageInput): Promise<{
        author: {
            id: string;
            username: string;
            avatar: string;
